...
<sql:setDataSource
    ...
    /> 
    <sql:query var="etat" dataSource="${myDS}">
      select IF(projet.bienmobilier.qteLivre < projet.bienmobilier.stockMin, 'bientot epuisee', 'bien enstock') as 'etat' from projet.bienmobilier;
    </sql:query>
...
<div class="row">
		...
		<div class="container">
			<h3 class="text-center"><img alt="" src="https://www.laformation.ma/im/200/images/300/eco-ca2ll493ui7y7s6immpq2i9bau6jl001022016124644.jpg" heigth=60 width=60>Inventaire Physique</h3>
			<hr>
								...
								<tr>
                                   <td><c:out value="${user.refBien}"/></td>
          						   <td><c:out value="${user.famille}"/></td>
       						       ...
       						       <td><c:out value="${etat.rows[loop.count-1].etat}"/></td>
