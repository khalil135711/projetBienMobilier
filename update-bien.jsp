...
<div class="form-group">
  <label class="col-md-4 control-label" for="product_id"> </label>  
  <div class="col-md-4">
  <input id="product_id" name="refBien" placeholder="reference Bien" class="form-control input-md"  value="${us.refBien}" required="" type="hidden">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name">Designation</label>  
  <div class="col-md-4">
  <input id="product_name" name="designation" placeholder="Designation" class="form-control input-md" value="${us.designation}" required="" type="text">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_categorie">famille du bien</label>
  <div class="col-md-4">
    <select id="product_categorie" name="idFam" class="form-control">
       <c:forEach var="user" items="${listFamille.rows}">
         <option value=<c:out value="${user.nomfamille}"/>><c:out value="${user.nomfamille}"/></option>
                              </c:forEach>
    </select>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="available_quantity"> QUANTITY minimal</label>  
  <div class="col-md-4">
  <input id="available_quantity" name="stockMin" placeholder="minimal QUANTITY" class="form-control input-md" value="${us.stockMin}" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_weight">numero Bien</label>  
  <div class="col-md-4">
  <input id="product_weight" name="numBE" placeholder="numero du bien mobilier" class="form-control input-md" value="${us.numBE}" required="" type="text">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_description">Emplacement </label>
  <div class="col-md-4">                     
    <textarea class="form-control" placeholder="svp ecrire toute les emplacements du bien mobilier" name="emplacement" value="${us.emplacement}"></textarea>
  </div>
</div>

<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name_fr">caracteristiqueTech</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="product_name_fr" name="caracteristiqueTech" value="${us.caracteristiqueTech}"></textarea>
  </div>
</div>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="percentage_discount">nom Fournisseur</label>  
  <div class="col-md-4">
  <input id="percentage_discount" name="nomFournisseur" placeholder=" Fournisseur name" class="form-control input-md" value="${us.nomFournisseur}" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="author">quantite Livre</label>  
  <div class="col-md-4">
  <input id="author" name="qteLivre" placeholder="qte livre" class="form-control input-md" value="${us.qteLivre}" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="enable_display">Code Barre</label>  
  <div class="col-md-4">
  <input id="enable_display" name="codeBarre" placeholder="ENABLE DISPLAY" class="form-control input-md" value="${us.codeBarre}" required="" type="text">
   ...
   <!--  
<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton">image de bien</label>
  <div class="col-md-4">
    <input type="file" id="avatar" name="img"
accept=".png, .jpg, .jpeg"  value="${us.img}" placeholder="img">
  </div>
</div>


<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton">document liees</label>
  <div class="col-md-4">
    <input id="filebutton" name="documentLies" class="input-file" value="${us.documentLies}" type="file">
  </div>
</div>-->
