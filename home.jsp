...
<body>
 <div class="menu-btn">
  ...
  <div class="container">
    <!-- Nav -->
    <nav class="main-nav">
      <img src="https://img.icons8.com/bubbles/2x/education.png" height='50px' weight='30px' alt="bien mobilier" class="logo">

      <ul class="main-menu">
        <li><a href="http://localhost:8080/projet/login">login</a></li>
        <li><a href="#">creer un compte</a></li>
        <li><a href="#">contacter administartion</a></li>
      </ul>
