	...
	<div class="row">
		...
		<div class="container">
			...
			<c:if test="${dlt}">
				...
				<a href="<%=request.getContextPath()%>/addBonds.jsp" class="btn btn-success">Ajouter un bon de sortie </a>
			</div>
			<br>
                ...
                <table class="table" id="myTable">
                  ...
                  <c:forEach var="user" items="${users}">
						...
						<tr>
							...
							<td><c:out value="${user.idbonDS}" /></td>
							<td><c:out value="${user.dateBS}" /></td>
							<td><c:out value="${user.nomDemandeur}" /></td>
							<td><c:out value="${user.refBien}" /></td>
							<td><c:out value="${user.qteServie}" /></td>
							<td>
								 
								<a
								href="deleteBonds?idBonDS=<c:out value='${user.idbonDS}' />"><img alt="" src="https://ouch-cdn2.icons8.com/dHX-QjDDOOSG1CLJccad4PBNtaeMHTzWzgZoSvCkcxA/rs:fit:256:215/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvNDIy/Lzg1MzlkMWI5LTc0/MjgtNDg4ZS1hMDdl/LTZjMDA3ZDUxYjQ5/MC5wbmc.png" height="30px" width="30px"></a></td>
