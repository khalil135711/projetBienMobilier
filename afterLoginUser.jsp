   ...
   <div class="navbar-fixed">
    <nav class="navbar white">
     <div class="nav-wrapper">
      <a href="#!" class="brand-logo grey-text text-darken-4">ESPACE etudiant</a>
   ...
   <ul id="sidenav-left" class="sidenav sidenav-fixed">
    <li>
     <a href="/pages/admin-dashboard" class="logo-container"
      >etudiant<i class="material-icons left">spa</i></a
     >
    </li>
    <li class="no-padding">
      ...
      <li class="bold waves-effect active">
       ...
       <div class="collapsible-body">
        <ul>
         ...
         <li>
          <a href="http://localhost:8080/projet/etudiantbien-list.jsp" class="waves-effect"
