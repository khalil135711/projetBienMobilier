...
<body >
<form class="form-horizontal" action="registerBonde" method="post"  enctype="multipart/form-data">
<fieldset>

<!-- Form Name -->
<legend>bons d'entree</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name_fr">num bon d entree</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="product_name_fr" name="numBE"></textarea>
  </div>
</div>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="percentage_discount">date bon d'entree</label>  
  <div class="col-md-4">
  <input  name="dateBE"   type="date">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="author">num Facture</label>  
  <div class="col-md-4">
  <input id="author" name="numFac" placeholder="num Facture" class="form-control input-md" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="enable_display"> date Facture</label>  
  <div class="col-md-4">
  <input id="enable_display" name="dateFac" placeholder="yyyy-mm-dd" class="form-control input-md" required="" type="date">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton">description du bon d entree</label>
  <div class="col-md-4">
    <input id="filebutton" name="description" class="input-file" type="file">
  </div>
</div>
